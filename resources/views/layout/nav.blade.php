        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
                <div>
                    ...
                    <a href="#" class="blog-nav-item dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">@if(!empty(\Auth::user()->name)){{\Auth::user()->name}} @else 未登录 @endif<span class="caret"></span></a>
