...
<div class="col-sm-8 blog-main">
            ...
            <div>
                ...
                <div class="blog-post">
                    ...
                    <p class="blog-post-meta">{{$item->created_at->toFormattedDateString()}} by <a href="/user/{{$item->user->id}}">{{$item->user->name}}</a></p>

                    {!! str_limit($item->content, 100, '...') !!}
                    <p class="blog-post-meta">赞 {{$item->zans_count}} | 评论 {{$item->comments_count}}</p>
                </div>
                @endforeach
